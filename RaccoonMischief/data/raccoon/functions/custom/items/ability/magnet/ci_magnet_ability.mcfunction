#execute as @e[type=minecraft:item] if entity @a[scores={rm_holding_magnet=2},distance=0..5,sort=nearest,limit=1] as @s facing entity @a[scores={rm_holding_magnet=2},distance=0..5,sort=nearest,limit=1] eyes run tp @s ^ ^ ^0.1
...
#tp items
execute as @e[type=minecraft:item,nbt=!{Item:{tag:{magnet:1b}}},distance=0..5,sort=nearest] at @s run tp @s @a[scores={rm_holding_magnet=2..},distance=0..5,sort=nearest,limit=1]

#tp xp orb
execute as @e[type=minecraft:experience_orb,distance=0..5,sort=nearest] at @s run tp @s @a[scores={rm_holding_magnet=2..},distance=0..5,sort=nearest,limit=1]