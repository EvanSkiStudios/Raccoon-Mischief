...
execute as @a[scores={RMVer=1..}] run tellraw @p {"text":"Raccoon Mischief Version 1.2.1","color":"green","italic":false}
scoreboard players set @a RMVer 0

#scoreboard
execute as @a[scores={deathcount=100..}] run advancement grant @s only raccoon:chaos/challenges/deaths
