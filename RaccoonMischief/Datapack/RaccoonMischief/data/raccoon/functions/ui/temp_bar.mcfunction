...
execute if score @s com.mercerenies.turtletroll.TemperatureManager.SCOREBOARD_NAME matches 10.. unless entity @s[nbt={Inventory:[{Slot:100b}]}] unless entity @s[nbt={Inventory:[{Slot:101b}]}] unless entity @s[nbt={Inventory:[{Slot:102b}]}] unless entity @s[nbt={Inventory:[{Slot:103b}]}] if entity @s[nbt=!{Inventory:[{Slot:103b,id:"minecraft:carved_pumpkin"}]}] run title @s actionbar [{"text":"\uF82B\uF82A\uF825"},{"text":"\uF829\uF829\uF829\uF829\uF829\uF829\uF838\uE001"}]
...
execute if score @s com.mercerenies.turtletroll.TemperatureManager.SCOREBOARD_NAME matches 10.. run execute as @a unless entity @s[nbt=!{Inventory:[{Slot:103b}]}] if entity @s[nbt=!{Inventory:[{Slot:103b,id:"minecraft:carved_pumpkin"}]}] run title @s actionbar [{"text":"\uF82B\uF82A\uF825"},{"text":"\uF829\uF829\uF829\uF829\uF829\uF829\uF838\uE000"}]
