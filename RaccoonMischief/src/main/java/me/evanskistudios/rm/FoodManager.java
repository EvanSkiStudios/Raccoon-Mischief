...
public class FoodManager {
    ...
    public static ItemStack DebugChicken = FoodItem(Material.CHICKEN, ChatColor.GREEN +""+ ChatColor.ITALIC + "DEBUG CHICKEN", 69, new NamespacedKey(plugin, "Debug_Chicken"));
}
